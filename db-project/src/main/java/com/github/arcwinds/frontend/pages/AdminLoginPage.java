...
public class AdminLoginPage extends MainLayout {
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(idNumberLabel)
                                        .addComponent(idNumberField, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(10, 10, 10)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(phoneNumberLabel)
    ...
    private void loginButtonActionPerformed() {
        ...
        if (username.isEmpty() || password.isEmpty() || idNumber.isEmpty() || phoneNumber.isEmpty()) {
            messageLabel.setText("Συμπληρώστε όλα τα πεδία!");
            return;
        }

        boolean isAdmin = mf.loginAdmin(username, password, idNumber, phoneNumber);
        if (isAdmin) {
